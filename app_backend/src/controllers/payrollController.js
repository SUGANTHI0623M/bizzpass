...
const calculateAttendanceStats = async (employeeId, month, year) => {
    ...
    let totalPossibleDays = 0; // Total days considered (after joining)
    ...
    // Working days = Total days considered - Weekly Off Days - Holidays
    const workingDays = totalPossibleDays - weeklyOffDays - holidays;
