...
class _DashboardScreenState extends State<DashboardScreen> {
  ...
  void _onNavigationRequest(int index, {int subTabIndex = 0}) {
    setState(() {
      _currentIndex = index;
      if (index == 1) _requestTabIndex = subTabIndex;
      if (index == 4 && !_isCandidate) _attendanceTabIndex = subTabIndex;
    });
  }
  ...
  Widget build(BuildContext context) {
    ...
    final List<Widget> screens = [
      ...
      MyRequestsScreen(key: ValueKey('Requests_$_requestTabIndex'), initialTabIndex: _requestTabIndex),
