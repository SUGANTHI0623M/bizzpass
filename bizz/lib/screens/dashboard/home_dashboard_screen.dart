...
class _HomeDashboardScreenState extends State<HomeDashboardScreen> {
  ...
  Future<void> _calculateSalaryFromModule() async {
    try {
      ...
      // 7. Fine calculation – Present/Approved only. Half Day must NOT incur late login fine.
      ...
      // Use calculatePayrollFine only for Present/Approved (excludes Half Day)
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        elevation: 0,
        actions: [
          AppActionIcon(icon: Icons.notifications_outlined, onPressed: () {}),
        ],
      ),
            ...
            children: [
                ...
                children: [
                  ...
                  if (!_isCandidate)
                    _buildSummaryCard(
                      ...
                      subValue: 'of $totalDaysForCard days',
                      isWide: isWide,
                    ),
                ],
              ),
              ...
              Row(
                ...
                children: [
                  ...
                  TextButton(
                    onPressed: () => widget.onNavigate?.call(1, subTabIndex: 0),
                    child: Text(
                      'SEE ALL',
                      style: TextStyle(
              ...
              const SizedBox(height: 12),
              _buildRecentLeavesCard(context),
            ],
          ),
        ),
      ),
            ...
            Column(
              ...
              children: [
                ...
                Text(
                  ...
                  style: TextStyle(
                    fontSize: 13,
                    color: const Color(0xFF1A1E29).withValues(alpha: 0.85),
                  ),
                ),
              ],
            ),
  ...
  Widget _buildRecentLeavesCard(BuildContext context) {
    final colors = AppColors.of(context);
    return Column(
      crossAxisAlignment: CrossAxisAlignment.start,
      children: [
          ...
          ...(_recentLeaves
              ...
              .map(
                (leave) => Padding(
                  ...
                  child: _buildActivityCard(context, leave),
                ),
              )),
      ],
    );
  ...
  Widget _buildActivityCard(BuildContext context, dynamic leave) {
    final colors = AppColors.of(context);
    ...
    final title = 'Leave ${status.isNotEmpty ? status : 'Request'}';
    final daysAgo = _getDaysAgo(leave['createdAt'] ?? leave['startDate']);
    return InkWell(
      onTap: () => widget.onNavigate?.call(1, subTabIndex: 0),
      borderRadius: BorderRadius.circular(12),
      child: Container(
  ...
  String _getDaysAgo(dynamic dateVal) {
    if (dateVal == null) return '';
    try {
      final d = dateVal is DateTime
          ? dateVal
  ...
  Widget _buildMonthAttendanceCard(BuildContext context) {
    final colors = AppColors.of(context);
      ...
      children: [
        ...
        GridView.builder(
          ...
          itemBuilder: (context, index) {
            ...
            final leaveTypeAbbr =
                (statusForDay == 'Present' || statusForDay == 'Approved') &&
