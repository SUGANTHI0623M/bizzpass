...
final BorderRadius kFormButtonRadius = BorderRadius.circular(14);
final BorderRadius kFormInputRadius = BorderRadius.circular(14);
...
InputDecoration _formInputDecoration({
  ...
  Widget? prefixIcon,
    ...
    InputDecoration(
      ...
      border: OutlineInputBorder(borderRadius: kFormInputRadius),
      enabledBorder: OutlineInputBorder(
        borderRadius: kFormInputRadius,
...
Widget _buildPrimarySubmitButton({
  ...
  return SizedBox(
    ...
    child: Material(
      ...
      child: InkWell(
        onTap: onPressed,
        borderRadius: kFormButtonRadius,
        child: Container(
          ...
          Padding(
            ...
            child: Column(
              children: [
                ...
                // Status filter chips - "All Status" shows gold background when selected
                Wrap(
                  spacing: 8,
                  runSpacing: 8,
...
class _ApplyLeaveDialogState extends State<ApplyLeaveDialog> {
    ...
    if (mounted) {
      if (result['success']) {
        setState(() {
          ...
          // Ensure "Half Day" is in the list
          final hasHalfDay = _allowedTypes.any((e) => e['type'].toString().toLowerCase() == 'half day');
          if (!hasHalfDay) {
            _allowedTypes.add({'type': 'Half Day'});
          }
  ...
  Future<void> _submit() async {
    ...
    if (_leaveType == 'Half Day' && _session == null) {
      SnackBarUtils.showSnackBar(context, 'Please select a session for Half Day leave', isError: true);
      return;
    }
    ...
    final result = await _requestService.applyLeave({
      ...
      'days': _leaveType == 'Half Day' ? 0.5 : _days,
          ...
          child: Form(
            ...
            child: Column(
              ...
              children: [
                    ...
                    Row(
                      children: [
                        Container(
                          ...
                          child: Icon(Icons.calendar_month, color: AppColors.primary, size: 24),
                        ),
                ...
                if (_leaveType == 'Half Day') ...[
                  ...
                  Row(
                    children: [
                      Expanded(
                        child: InkWell(
                          onTap: () => setState(() => _session = 'Session 1'),
                          borderRadius: BorderRadius.circular(12),
                          child: Container(
                            padding: const EdgeInsets.symmetric(vertical: 14),
                            decoration: BoxDecoration(
                              color: _session == 'Session 1' ? AppColors.primary.withValues(alpha: 0.12) : AppColors.cardSurface,
                              border: Border.all(color: _session == 'Session 1' ? AppColors.primary : AppColors.cardBorder),
                              borderRadius: BorderRadius.circular(12),
                            ),
                            child: Column(
                              children: [
                                Text(
                                  ...
                                  style: TextStyle(
                                    fontWeight: FontWeight.bold,
                                    color: _session == 'Session 1' ? AppColors.primary : Colors.black87,
                                  ),
                                ),
                                const Text('First Half', style: TextStyle(fontSize: 10, color: Colors.grey)),
                              ],
                            ),
                          ),
                        ),
                      ...
                      Expanded(
                        child: InkWell(
                          onTap: () => setState(() => _session = 'Session 2'),
                          borderRadius: BorderRadius.circular(12),
                          child: Container(
                            padding: const EdgeInsets.symmetric(vertical: 14),
                            decoration: BoxDecoration(
                              color: _session == 'Session 2' ? AppColors.primary.withValues(alpha: 0.12) : AppColors.cardSurface,
                              border: Border.all(color: _session == 'Session 2' ? AppColors.primary : AppColors.cardBorder),
                              borderRadius: BorderRadius.circular(12),
                            ),
                            child: Column(
                              children: [
                                Text(
                                  ...
                                  style: TextStyle(
                                    fontWeight: FontWeight.bold,
                                    color: _session == 'Session 2' ? AppColors.primary : Colors.black87,
                                  ),
                                ),
                                const Text('Second Half', style: TextStyle(fontSize: 10, color: Colors.grey)),
                              ],
                            ),
                          ),
                        ),
                ...
                Text(
                  '${_leaveType == 'Half Day' ? 'Date' : (_isOneDay ? 'Date' : 'Start Date')} *',
                  style: const TextStyle(
                    fontWeight: FontWeight.w600,
                    fontSize: 15,
                    color: AppColors.textPrimary,
                      ...
                      child: Row(
                        ...
                        children: [
                          Text(
                            ...
                            style: TextStyle(
                              color: _endDate == null ? AppColors.textSecondary : AppColors.textPrimary,
                              fontSize: 15,
                            ),
                          ),
                          Icon(Icons.calendar_today, size: 20, color: AppColors.primary),
                ...
                if (_days > 0 || _leaveType == 'Half Day')
                  Padding(
                    ...
                    child: Text(
                      _leaveType == 'Half Day' ? 'Total Days: 0.5' : 'Total Days: $_days',
                      style: TextStyle(
                        color: AppColors.primary,
                        fontWeight: FontWeight.bold,
                      ),
                ...
                TextFormField(
                  ...
                  maxLines: 3,
                  decoration: _formInputDecoration(hintText: 'Enter reason for leave'),
                  validator: (val) =>
                  ...
                  children: [
                    OutlinedButton(
                      ...
                      style: OutlinedButton.styleFrom(
                        ...
                        shape: RoundedRectangleBorder(borderRadius: kFormButtonRadius),
                      ),
          ...
          child: Form(
            ...
            child: Column(
              ...
              children: [
                    ...
                    Row(
                      children: [
                        ...
                        Column(
                          crossAxisAlignment: CrossAxisAlignment.start,
                          children: [
                            const Text('Request Loan', style: TextStyle(fontSize: 20, fontWeight: FontWeight.bold, color: AppColors.textPrimary)),
                            Text('Submit a new loan request', style: TextStyle(fontSize: 14, color: AppColors.textSecondary)),
                          ],
                        ),
                      ],
                    ),
                ...
                const SizedBox(height: 24),
                const Text('Loan Type', style: TextStyle(fontWeight: FontWeight.w600, fontSize: 15, color: AppColors.textPrimary)),
                const SizedBox(height: 8),
                DropdownButtonFormField<String>(
                  initialValue: _loanType,
                  items: ['Personal', 'Advance', 'Emergency'].map((e) => DropdownMenuItem(value: e, child: Text(e))).toList(),
                  onChanged: (val) => setState(() => _loanType = val!),
                  decoration: _formInputDecoration(),
                ),
                const SizedBox(height: 16),
                const Text('Amount (₹) *', style: TextStyle(fontWeight: FontWeight.w600, fontSize: 15, color: AppColors.textPrimary)),
                const SizedBox(height: 8),
                TextFormField(
                  controller: _amountController,
                  keyboardType: TextInputType.number,
                  decoration: _formInputDecoration(hintText: 'Enter loan amount'),
                  validator: (val) => val == null || val.isEmpty ? 'Amount is required' : null,
                ),
                const SizedBox(height: 16),
                const Text('Tenure (Months) *', style: TextStyle(fontWeight: FontWeight.w600, fontSize: 15, color: AppColors.textPrimary)),
                const SizedBox(height: 8),
                TextFormField(
                  controller: _tenureController,
                  keyboardType: TextInputType.number,
                  decoration: _formInputDecoration(hintText: 'Enter tenure in months'),
                  validator: (val) {
                ...
                const SizedBox(height: 16),
                const Text('Interest Rate (%)', style: TextStyle(fontWeight: FontWeight.w600, fontSize: 15, color: AppColors.textPrimary)),
                const SizedBox(height: 8),
                TextFormField(
                ...
                const SizedBox(height: 16),
                const Text('Purpose *', style: TextStyle(fontWeight: FontWeight.w600, fontSize: 15, color: AppColors.textPrimary)),
                const SizedBox(height: 8),
                TextFormField(
                  controller: _purposeController,
                  maxLines: 3,
                  decoration: _formInputDecoration(hintText: 'Enter purpose of loan'),
                ...
                Row(
                  ...
                  children: [
                    OutlinedButton(
                      onPressed: () => Navigator.pop(context),
                      style: OutlinedButton.styleFrom(foregroundColor: AppColors.primary, side: BorderSide(color: AppColors.primary), padding: const EdgeInsets.symmetric(horizontal: 24, vertical: 14), shape: RoundedRectangleBorder(borderRadius: kFormButtonRadius)),
                      child: const Text('Cancel'),
                    ),
                    const SizedBox(width: 12),
                    _buildPrimarySubmitButton(onPressed: _isSubmitting ? null : _submit, isLoading: _isSubmitting, label: 'Submit Request'),
                  ],
                ),
              ],
            ),
          ...
          child: Form(
            ...
            child: Column(
              ...
              children: [
                    ...
                    Row(
                      children: [
                        ...
                        Column(
                          crossAxisAlignment: CrossAxisAlignment.start,
                          children: [
                            const Text('Claim Expense', style: TextStyle(fontSize: 20, fontWeight: FontWeight.bold, color: AppColors.textPrimary)),
                            Text('Submit a new expense claim', style: TextStyle(fontSize: 14, color: AppColors.textSecondary)),
                          ],
                        ),
                      ],
                    ),
                ...
                const SizedBox(height: 24),
                const Text('Expense Type', style: TextStyle(fontWeight: FontWeight.w600, fontSize: 15, color: AppColors.textPrimary)),
                const SizedBox(height: 8),
                DropdownButtonFormField<String>(
                  initialValue: _expenseType,
                  items: ['Travel', 'Food', 'Accommodation', 'Other'].map((e) => DropdownMenuItem(value: e, child: Text(e))).toList(),
                ...
                TextFormField(
                  controller: _amountController,
                  keyboardType: TextInputType.number,
                  decoration: _formInputDecoration(hintText: 'Enter expense amount'),
                  validator: (val) => val == null || val.isEmpty ? 'Amount is required' : null,
                ),
                const SizedBox(height: 16),
                const Text('Date *', style: TextStyle(fontWeight: FontWeight.w600, fontSize: 15, color: AppColors.textPrimary)),
                const SizedBox(height: 8),
                InkWell(
                  onTap: _pickDate,
                  borderRadius: kFormInputRadius,
                  child: Container(
                    ...
                    child: Row(
                      ...
                      children: [
                        Text(
                          _date == null ? 'dd-mm-yyyy' : DateFormat('dd-MM-yyyy').format(_date!),
                          style: TextStyle(color: _date == null ? AppColors.textSecondary : AppColors.textPrimary, fontSize: 15),
                        ),
                        Icon(Icons.calendar_today, size: 20, color: AppColors.primary),
                      ],
                    ),
                ...
                const SizedBox(height: 16),
                const Text('Description *', style: TextStyle(fontWeight: FontWeight.w600, fontSize: 15, color: AppColors.textPrimary)),
                const SizedBox(height: 8),
                TextFormField(
                  controller: _descriptionController,
                  maxLines: 3,
                  decoration: _formInputDecoration(hintText: 'Enter expense description'),
                  validator: (val) => val == null || val.isEmpty ? 'Description is required' : null,
                ),
                const SizedBox(height: 16),
                const Text('Proof Document *', style: TextStyle(fontWeight: FontWeight.w600, fontSize: 15, color: AppColors.textPrimary)),
                const SizedBox(height: 8),
                InkWell(
                  onTap: _pickFile,
                  borderRadius: kFormInputRadius,
                  child: Container(
                    ...
                    child: Row(
                      ...
                      children: [
                        Expanded(
                          child: Text(
                            _selectedFile != null ? _selectedFile!.path.split('/').last : 'Select file (Image/PDF)',
                            overflow: TextOverflow.ellipsis,
                            style: TextStyle(color: _selectedFile != null ? AppColors.textPrimary : AppColors.textSecondary, fontSize: 15),
                          ),
                        ),
                        Icon(Icons.attach_file, size: 20, color: AppColors.primary),
                      ],
                    ),
                  ),
                ),
                ...
                Row(
                  ...
                  children: [
                    ...
                    const SizedBox(width: 12),
                    _buildPrimarySubmitButton(onPressed: _isSubmitting ? null : _submit, isLoading: _isSubmitting, label: 'Submit Claim'),
                  ],
                ),
              ],
            ),
          ...
          child: Form(
            ...
            child: Column(
              ...
              children: [
                    ...
                    Row(
                      children: [
                        ...
                        Column(
                          crossAxisAlignment: CrossAxisAlignment.start,
                          children: [
                            const Text('Request Payslip', style: TextStyle(fontSize: 20, fontWeight: FontWeight.bold, color: AppColors.textPrimary)),
                            Text('Request payslip for month(s)', style: TextStyle(fontSize: 14, color: AppColors.textSecondary)),
                          ],
                        ),
                      ],
                    ),
                ...
                if (!_isBulkMode) ...[
                  const Text('Month', style: TextStyle(fontWeight: FontWeight.w600, fontSize: 15, color: AppColors.textPrimary)),
                  const SizedBox(height: 8),
                  DropdownButtonFormField<String>(
                    value: _month,
                  ...
                  const Text('Select Months *', style: TextStyle(fontWeight: FontWeight.w600, fontSize: 15, color: AppColors.textPrimary)),
                  const SizedBox(height: 8),
                  Container(
                    decoration: BoxDecoration(
                      color: Colors.white,
                ...
                const Text('Year *', style: TextStyle(fontWeight: FontWeight.w600, fontSize: 15, color: AppColors.textPrimary)),
                const SizedBox(height: 8),
                TextFormField(
                  controller: _yearController,
                  keyboardType: TextInputType.number,
                  decoration: _formInputDecoration(hintText: 'Enter year'),
                  validator: (val) => val == null || val.isEmpty ? 'Year is required' : null,
                ),
                const SizedBox(height: 16),
                const Text('Reason *', style: TextStyle(fontWeight: FontWeight.w600, fontSize: 15, color: AppColors.textPrimary)),
                const SizedBox(height: 8),
                TextFormField(
                  controller: _reasonController,
                  maxLines: 3,
                  decoration: _formInputDecoration(hintText: 'Enter reason for payslip request'),
                ...
                Row(
                  ...
                  children: [
                    ...
                    _buildPrimarySubmitButton(
                      onPressed: _isSubmitting ? null : _submit,
                      isLoading: _isSubmitting,
                      label: _isBulkMode ? 'Submit Bulk Request' : 'Submit Request',
                    ),
                  ],
                ),
              ],
